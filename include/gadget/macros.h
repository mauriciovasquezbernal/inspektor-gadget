...
#define GADGET_TRACE_MAP(tracer_name, map_name, type) \
	const void * gadget_trace_map_##tracer_name##___##map_name##___##type __attribute__((unused)); \
	const struct type * gadget_trace_type_##name __attribute__((unused));
