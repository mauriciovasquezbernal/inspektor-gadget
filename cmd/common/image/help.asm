...
section        .data                   ; here you declare the data
    msg        db "Hi! Gadgets must be run with the ig command. Please check the documentation at www.inspektor-gadget.io to get more details!"       ; the actual message to use
