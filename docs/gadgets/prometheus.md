...
TODO: it should be a start / stop gadget for the kubectl-gadget case
...
```bash
$ kubectl gadget prometheus --config /tmp/myconfig.yaml --listen-address 127.0.0.1:2223 --metrics-path /metrics
