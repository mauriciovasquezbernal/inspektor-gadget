...
func (t *Tracer) install() error {
	...
	if err != nil {
		return fmt.Errorf("attaching tracing block_rq_complete: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("attaching tracing for block_rq_insert: %w", err)
	}
	...
	if err != nil {
		return fmt.Errorf("attaching tracing for block_rq_issue: %w", err)
	}
